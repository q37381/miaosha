...
import com.geekq.miaosha.redis.CountKey;
import com.geekq.miaosha.redis.RedisCountUtil;
...
public class LoginController {
    ...
    public String tologin(LoginVo loginVo, Model model) {
        ...
        Long incr = RedisCountUtil.initOrIncrVisitCount(redisService);
        //String count = RedisLua.getVistorCount(COUNTLOGIN).toString();
        String count = incr.toString();
    ...
    @ResponseBody
    public ResultGeekQ<Boolean> dologin(HttpServletRequest request, HttpServletResponse response, @Valid LoginVo loginVo) {
